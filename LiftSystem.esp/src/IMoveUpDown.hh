...
#include <vector>
#include <map>
#ifndef IMOVEUPDOWN_HH
#define IMOVEUPDOWN_HH
struct IMoveUpDown
{
  enum struct State
    {
  ...
  int dzn_state;
  ::IMoveUpDown::State state;
  IMoveUpDown (dzn::port::meta const& m);
  template <typename Component>
  IMoveUpDown (dzn::port::meta const& m, Component* that)
  : dzn_meta (m)
  , dzn_share_p (true)
  , dzn_label ("")
  , dzn_state ()
...
namespace dzn
{
  inline void connect (::IMoveUpDown& provide, ::IMoveUpDown& require)
    {
